...
//         );
//
//     internal static readonly Parser<char, IStringParameter> WhiteSpaceParameter =
//         Grammar.WhiteSpaces.Select<IStringParameter>(str => new StringParameter(str));
//     
//     internal static readonly Parser<char, IStringParameter> StringParameterOld =
//         Parser.OneOf(StringInParentheses, String)
//             .Select<IStringParameter>(str => new StringParameter(str));
//     
//     internal static readonly Parser<char, IStringParameter> StringFormatParameter =
//         String
//             .Between(CommonParser.DoubleQuotes)
//             .Select<IStringParameter>(str => new StringFormatParameter(str));
//     
//     internal static readonly Parser<char, IStringParameter> StringParameter =
